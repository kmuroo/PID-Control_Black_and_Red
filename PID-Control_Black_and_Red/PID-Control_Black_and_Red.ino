...
float Ku_Black = 79.0; //高畠・長倉実験結果を基に変更 95.0 → 79.0 2025/10/31
float Pu_Black = 4.5;  //高畠・長倉実験結果を基に変更 4.35 → 4.5
...
//----- ジーグラ・ニコルス限界感度法における初期設定値  2025/7/23 変更--------------------
//----- Ti, TdとKi, Kd を混同していたのを修正 2025/1021 変更---------------------------
float Ku_Red = 99.0;    //高畠・長倉実験結果を基に変更 120.0 → 99.0 2025/10/31
float Pu_Red = 10.2;    //高畠・長倉実験結果を基に変更 1.11 → 10.2
